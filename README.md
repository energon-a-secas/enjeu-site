...
Enjeu is a solo boss rush played with ninety-four printed cards, one die, and whatever
...
- **Cards** -- all 94 faces, browsable by deck; tap one for its name and what it does, because the face never says
- **Print** -- 63 x 88 mm poker cards, 9 per A4 sheet, 11 sheets, crop ticks, optional Letter paging and card backs
...
| **[data/cards.json](data/cards.json)** | All 94 cards as data. |
...
├── data/
│   ├── cards.json          # all 94 cards, the one source
