...
export const STRINGS = {
  en: {
    ...
    cards: {
      title: 'The cards',
      lead: 'Ninety-two cards, poker size, no words on any of them. The picture is the name, the corners carry the numbers. Tap a card to see what it does.',
      printAll: 'Print all 92 (11 sheets)',
