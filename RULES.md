...
minifigures and bricks. **Stake** is not affiliated with, endorsed by, or connected to
...
|---|---|---|---|---|
| **Strike** | 1 | — | 25 | none, it always lands |
...
| Mountain | Earth | — |
| Desert | Wind | — |
| Forest | — | Hide costs 0 actions. |
| Village | — | You start the level with 1 extra Ready life card. |
| Castle | — | The boss acts twice on round 1. |
