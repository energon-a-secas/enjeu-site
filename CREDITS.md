...
|---|---|---|---|
| [`adv-ally`](https://thenounproject.com/icon/skill-beast-wolf-2360189/) | Advantage: Ally | Maxicons | CC BY 3.0 |
| [`adv-barrier`](https://thenounproject.com/icon/skill-magic-barrier-2360190/) | Advantage: Barrier | Maxicons | CC BY 3.0 |
| [`adv-chest`](https://thenounproject.com/icon/item-treasure-chest-2360145/) | Advantage: Chest | Maxicons | CC BY 3.0 |
| [`adv-cure`](https://thenounproject.com/icon/game-ui-item-2360115/) | Advantage: Cure | Maxicons | CC BY 3.0 |
...
| [`biome-mountain`](https://thenounproject.com/icon/landscape-mountain-2360158/) | Biome: Mountain | Maxicons | CC BY 3.0 |
| [`biome-river`](https://thenounproject.com/icon/landscape-river-2360155/) | Biome: River | Maxicons | CC BY 3.0 |
| [`biome-village`](https://thenounproject.com/icon/landscape-village-2360156/) | Biome: Village | Maxicons | CC BY 3.0 |
...
| [`skill-cyclone`](https://thenounproject.com/icon/typhoon-6776949/) | Skill: Cyclone (wind t1) | Pandu Bramantyo | CC BY 3.0 |
| [`skill-deluge`](https://thenounproject.com/icon/drowning-10830/) | Skill: Deluge (water t4) | Luis Prado | CC BY 3.0 |
| [`skill-earthquake`](https://thenounproject.com/icon/skill-magic-earthquake-2360193/) | Skill: Earthquake | Maxicons | CC BY 3.0 |
| [`skill-ember`](https://thenounproject.com/icon/fire-315160/) | Skill: Ember (fire t0) | Alexander Skowalsky | CC BY 3.0 |
| [`skill-firebolt`](https://thenounproject.com/icon/fire-315159/) | Skill: Firebolt (fire t1) | Alexander Skowalsky | CC BY 3.0 |
| [`skill-gale`](https://thenounproject.com/icon/windy-6776957/) | Skill: Gale (wind t0) | Pandu Bramantyo | CC BY 3.0 |
| [`skill-hurricane`](https://thenounproject.com/icon/hurricane-8268736/) | Skill: Hurricane (wind t4) | Zpoliariumz Zydanez | CC BY 3.0 |
| [`skill-ice-spear`](https://thenounproject.com/icon/skill-magic-ice-spear-2360175/) | Skill: Ice Spear | Maxicons | CC BY 3.0 |
| [`skill-landslide`](https://thenounproject.com/icon/landslide-8035788/) | Skill: Landslide (earth t3) | Muhammad Nur Auliady Pamungkas | CC BY 3.0 |
| [`skill-maelstrom`](https://thenounproject.com/icon/tornado-5325195/) | Skill: Maelstrom (water t3) | ratacon studio | CC BY 3.0 |
| [`skill-meteor`](https://thenounproject.com/icon/skill-magic-meteor-2360172/) | Skill: Meteor (tier 4) | Maxicons | CC BY 3.0 |
| [`skill-nova`](https://thenounproject.com/icon/effect-damage-circle-2360033/) | Skill: Nova | Maxicons | CC BY 3.0 |
| [`skill-piercer`](https://thenounproject.com/icon/skill-gun-bullet-2360207/) | Skill: Piercer | Maxicons | CC BY 3.0 |
| [`skill-pyre`](https://thenounproject.com/icon/flame-8020212/) | Skill: Pyre (fire t3) | Ahmad Ishaq | CC BY 3.0 |
| [`skill-reaper`](https://thenounproject.com/icon/skill-dead-skull-2360206/) | Skill: Reaper | Maxicons | CC BY 3.0 |
| [`skill-slash`](https://thenounproject.com/icon/effect-slash-damage-2360030/) | Skill: Slash | Maxicons | CC BY 3.0 |
| [`skill-slash-wave`](https://thenounproject.com/icon/effect-slash-wave-2360038/) | Skill: Slash Wave | Maxicons | CC BY 3.0 |
| [`skill-soul-strike`](https://thenounproject.com/icon/skill-magic-soul-strike-2360160/) | Skill: Soul Strike | Maxicons | CC BY 3.0 |
| [`skill-tempest`](https://thenounproject.com/icon/tornado-5434776/) | Skill: Tempest (wind t2) | J703 | CC BY 3.0 |
| [`skill-thunderhead`](https://thenounproject.com/icon/thunder-8077206/) | Skill: Thunderhead (wind t3) | Relona Creative | CC BY 3.0 |
| [`skill-torrent`](https://thenounproject.com/icon/skill-magic-stream-2360191/) | Skill: Torrent | Maxicons | CC BY 3.0 |
| [`skill-tremor`](https://thenounproject.com/icon/earthquake-5554272/) | Skill: Tremor (earth t0) | WARHAMMER | CC BY 3.0 |
| [`strike`](https://thenounproject.com/icon/element-fist-2360069/) | Strike (attack card) | Maxicons | CC BY 3.0 |
